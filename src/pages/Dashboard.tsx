        ...
        <div className="grid gap-4 md:grid-cols-2">
          <Card>
            ...
            <CardContent>
              ...
              <p className="text-xs text-muted-foreground">Fail / Needs Info / Pending</p>
            </CardContent>
          </Card>

          <Card>
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
              <CardTitle className="text-sm font-medium">Estimated CO₂e</CardTitle>
              <Leaf className="h-4 w-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">{stats.emissionsTotal.toFixed(2)}</div>
              <p className="text-xs text-muted-foreground">Total estimate (kg CO₂e)</p>
            </CardContent>
          </Card>
        </div>
